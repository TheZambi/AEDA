...
public:
	...
	{
//	    CSimpleList newList;
	    CNode *aux1=lst.first, *auxObj=this->first;
//	    while(aux1!=0 || auxObj!=0)
//        {
//	        if(auxObj != NULL) {
//	            cout << auxObj->data() << endl;
//                newList.insert_end(auxObj->data());
//                auxObj = auxObj->next();
//            }
//	        if(aux1 != NULL) {
//                newList.insert_end(aux1->data());
//                aux1 = aux1->next();
//            }
//        }
//        cout << auxObj << endl;
...
//        }
        ...
        {
            if(aux1!=0) {
                CNode *add = new CNode(aux1->data(), auxObj->next());
                auxObj->setNext(add);
                aux1=aux1->next();
            }
            if(auxObj!=0) {
